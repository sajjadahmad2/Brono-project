...
<div data-kt-menu-trigger="{lg: 'hover'}" data-kt-menu-placement="bottom-start"
    class="menu-item here menu-here-bg menu-lg-down-accordion me-0 me-lg-2"><!--begin:Menu link--><a
        class="menu-link" href="{{ route('dashboard') }}"><span class="menu-title">Menus</span><span
            class="menu-arrow d-lg-none"></span></a><!--end:Menu link--><!--begin:Menu sub-->
            ...
            <div class="row">
                ...
                <div class="col-lg-8 mb-3 mb-lg-0  py-3 px-3 py-lg-6 px-lg-6">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="menu-item p-0 m-0">
                                ...
                                <a href="{{ route('dashboard') }}" class="menu-link ">
                                    <span
                                        class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                        <i class="ki-duotone ki-chart-simple text-gray-900 fs-1"><span
                                                class="path1"></span><span class="path2"></span><span
                                                class="path3"></span><span class="path4"></span></i> </span>
                    ...
                    <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                        ...
                        <a href="{{ route('dashboard') }}" class="btn btn-sm btn-primary fw-bold">
                            Explore
                        </a>
                    </div>
                    <!--end:Landing-->
                ...
                <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="/metronic8/demo1/dashboards/store-analytics.html" class="menu-link py-2 ">
                            <span class="menu-title">
