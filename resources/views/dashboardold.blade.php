...
@section('js')
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        allChartsRender(response.contact_stats);
                    }
                },
    ...
    <script>
        ...
        function allChartsRender(contactsStats) {
            let assignedUserData = contactsStats['grouped_contacts'];
            let datewiseContacts = contactsStats['datewise_contacts'];
            let total_contacts = contactsStats['total_contacts'];
            let groupedContactsByTags = contactsStats['grouped_contacts_by_tags'];
        ...
        //call all the charts
        let contactsStats = {!! json_encode($contact_stats) !!};
        allChartsRender(contactsStats);
    </script>
