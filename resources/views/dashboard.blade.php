                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Amount-->
                                    <span
                                        class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2 top_total_contact">LEADS</span>
                                    <!--end::Amount-->
                                </div>
                                <!--end::Info-->
                        ...
                        <div class="card-header pt-7">
                            ...
                            <div class="card-toolbar">
                                <a href="/metronic8/demo39/apps/ecommerce/sales/details.html"
                                    class="btn btn-sm btn-light">Order
                                    Details</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                            ...
                            <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <!--begin::Icon-->
                                            <img src="{{asset('icons/youtube.png')}}" class="w-55px ms-n1 me-10" alt="">
                                            <!--end::Icon-->
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <!--begin::Icon-->
                                            <img src="{{asset('icons/google.png')}}" class="w-55px ms-n1 me-10" alt="">
                                            <!--end::Icon-->
