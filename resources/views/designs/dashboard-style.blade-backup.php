                                        ...
                                        <div id="globalbgGradientContainer" style="display:none;">
                                            ...
                                            <div id="globalbgGradientColors" class="gr-colors">
                                                <div class="gradient-color-row">
                                                    <label for="globalbgGradientColor1">Color 1:</label>
                                                    <input type="color" id="globalbgGradientColor1"
                                                        class="globalbgGradientColor" oninput="applyStylesGlobal()">
                                                </div>
                                                <div class="gradient-color-row">
                                                    <label for="globalbgGradientColor2">Color 2:</label>
                                                    <input type="color" id="globalbgGradientColor2"
                                                        class="globalbgGradientColor" oninput="applyStylesGlobal()">
                                                </div>
                                            </div>
                                ...
                                <div class="sidebar-customizer customizer-main">
                                    ...
                                    <div>
                                        ...
                                        <input type="radio" id="fontColorCodeRadio" name="fontColorType"
                                            value="code" checked onclick="toggleColorInput('fontColor')"> Code
                                        <input type="radio" id="fontColorPickerRadio" name="fontColorType"
                                            value="picker" onclick="toggleColorInput('fontColor')"> Picker
                                        <input type="text" id="fontColorCode" name="fontColor"
                                            placeholder="e.g., #000000" oninput="applyStyles()">
                                        <input type="color" id="fontColorPicker" name="fontColor"
                                            style="display:none;" oninput="applyStyles()">
                                    </div>
                                    <div>
                                        <label for="bgColor">Background Color</label>
                                        <input type="radio" id="bgColorCodeRadio" name="bgColorType" value="code"
                                            checked onclick="toggleColorInput('bgColor')"> Code
                                        ...
                                        <input type="text" id="bgColorCode" name="bgColor"
                                            placeholder="e.g., #ffffff" oninput="applyStyles()">
                                        <input type="color" id="bgColorPicker" name="bgColor" style="display:none;"
                                            oninput="applyStyles()">
                                        <div id="bgGradientContainer" style="display:none;">
                                            ...
                                            <div id="bgGradientColors" class="gr-colors">
                                                <div class="gradient-color-row">
                                                    <label for="bgGradientColor1">Color 1:</label>
                                                    <input type="color" id="bgGradientColor1" class="bgGradientColor"
                                                        oninput="applyStyles()">
                                                </div>
                                                <div class="gradient-color-row">
                                                    <label for="bgGradientColor2">Color 2:</label>
                                                    <input type="color" id="bgGradientColor2" class="bgGradientColor"
                                                        oninput="applyStyles()">
                                                </div>
                                            </div>
                                            <button type="button" onclick="addGradientColor()">Add Color</button>
                                    ...
                                    <nav class="flex-1 w-full">
                                        @foreach ($navItems as $link)
                                            <a href="{{ $link['href'] }}"
                                                ...
                                                id="{{ $link['id'] }}" exact-path-active-class="exact-path-active-class"
                                                meta="{{ $link['meta'] }}">
                                    ...
                                    <div>
                                        ...
                                        <div id="cardbgGradientContainer" style="display:none;">
                                            ...
                                            <div id="cardbgGradientColors" class="gr-colors">
                                                <div class="gradient-color-row">
                                                    <label for="cardbgGradientColor1">Color 1:</label>
                                                    <input type="color" id="cardbgGradientColor1"
                                                        class="cardbgGradientColor" oninput="applyStylesCard()">
                                                </div>
                                                <div class="gradient-color-row">
                                                    <label for="cardbgGradientColor2">Color 2:</label>
                                                    <input type="color" id="cardbgGradientColor2"
                                                        class="cardbgGradientColor" oninput="applyStylesCard()">
                                                </div>
                                            </div>
                                            <button type="button" onclick="addGradientColorCard()">Add
                                                Color</button>
                                        </div>
                                    </div>
                                ...
                                <div class="chart-customizer customizer-main">
                                    ...
                                    <div>
                                        ...
                                        <input type="radio" id="labelsFontColorCodeRadio" name="labelsFontColorType"
                                            value="code" checked onclick="toggleColorInput('labelsFontColor')"> Code
                                        <input type="radio" id="labelsFontColorPickerRadio" name="labelsFontColorType"
                                            value="picker" onclick="toggleColorInput('labelsFontColor')"> Picker
                                    ...
                                    <div>
                                        ...
                                        <input type="radio" id="chartFillColorCodeRadio" name="chartFillColorType"
                                            value="code" checked onclick="toggleColorInput('chartFillColor')"> Code
                                        <input type="radio" id="chartFillColorPickerRadio" name="chartFillColorType"
                                            value="picker" onclick="toggleColorInput('chartFillColor')"> Picker
                                    ...
                                    <div>
                                        ...
                                        <input type="radio" id="chartStrokeColorCodeRadio" name="chartStrokeColorType"
                                            value="code" checked onclick="toggleColorInput('chartStrokeColor')"> Code
                                        <input type="radio" id="chartStrokeColorPickerRadio"
                                            name="chartStrokeColorType" value="picker"
                                            onclick="toggleColorInput('chartStrokeColor')"> Picker
...
@section('js')
    <script>
        ...
        document.querySelector('.save-css-btn').addEventListener('click', function(e) {
            e.preventDefault();
            //call copy css function to get the final css
            copyCSS(false);
