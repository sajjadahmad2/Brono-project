                    ...
                    <div class="card-header py-7">
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <!--begin::Title-->
                                <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2 total_contacts" id="total_contacts">0</span>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header py-7">
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <!--begin::Title-->
                                <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2 total_contacts" id="">0</span>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
